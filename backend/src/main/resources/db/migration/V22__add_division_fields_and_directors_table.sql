...
-- VALUES (1, 'Кафедра компьютерных систем'),
--        (1, 'Кафедра систем автоматизированного проектирования'),
--        (1, 'Кафедра автоматизированных систем обработки информации и управления'),
--        (1, 'Кафедра прикладной математики и информатики'),
--        (1, 'Кафедра систем информационной безопасности'),
--        (1, 'Кафедра динамики процессов и управления');
--
